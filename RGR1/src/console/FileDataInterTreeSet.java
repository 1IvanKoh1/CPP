...
public class FileDataInterTreeSet extends DataInterTreeSet {
    public FileDataInterTreeSet() {
        super();
    }

    public static void main(String[] args) {
        FileDataInterTreeSet fun = new FileDataInterTreeSet();
        int num;
        double x;
        ...
        System.out.println("Max x: " + fun.getPoint(0).getX());
        ...
        System.out.println("Значення інтерполяції f(" + x + ") = " +
                fun.evalf(x));
